...
void Matrix::MultPoint( Vec3& vec ) const
{
	Vec3 dst;
	MultPoint( dst, vec );
	vec = dst;
...
// assumes &dst != &src
void Matrix::MultPoint( Vec3& dst, const Vec3& src ) const
{
...
// assumes orthogonal
void Matrix::MultPointInverse( Vec3& vec ) const
{
	Vec3 dst;
...
// assumes &dst != &src
void Matrix::MultPointInverse( Vec3& dst, const Vec3& src ) const
{
